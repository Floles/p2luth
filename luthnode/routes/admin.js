...
router.post('/create', upload.single('image'), function (req, res, next) {
    ...
    connection.query('INSERT INTO products VALUES(NULL, ?, ?, ?, ?, ?, ?, NULL);', [req.body.product, req.body.reference, req.body.marque, req.body.bois_utilise, req.body.description, req.file.originalname],
